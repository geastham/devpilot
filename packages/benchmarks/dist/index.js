...
var WorkspaceManager = class {
  ...
  async cleanupWorkspace(workspaceId, options = {}) {
    ...
    try {
      await (0, import_promises3.rm)(info.rootDir, { recursive: true, force: true });
    } catch {
    }
...
var BaselineExecutor = class {
  ...
  async execute(workspace, collector) {
    ...
    const errors = [];
    try {
      const prdPath = (0, import_path5.join)(workspace.rootDir, "PRD.md");
...
var DevPilotExecutor = class {
  ...
  async execute(workspace, collector) {
    ...
    const errors = [];
    try {
      const prdPath = (0, import_path6.join)(workspace.rootDir, "PRD.md");
      ...
      for (const benchmarkRun of benchmarks) {
        ...
        if (benchmarkRun.waveAnalysis) {
          await this.resultsWriter.writeWaveAnalysis(
            (0, import_path7.join)(runDir, benchmarkRun.benchmarkId),

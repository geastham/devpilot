...
"[project]/src/stores/horizonStore.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/stores/fleetStore.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useFleetStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["devtools"])((set, get)=>({
        ...
        setRunway: (hours)=>set({
                runwayHours: hours,
                runwayStatus: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRunwayStatusFromHours"])(hours)
            }),
        setScore: (score)=>set({
...
_s(useFleetSSE, "yZvLpq5RTzhpioChUmCuq47jclE=", false, function() {
    return [
        useFleetStore
    ];
});
...
function useKeyboardShortcuts() {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        const handleKeyDown = (event)=>{
            ...
            if (event.key === 'Tab' && document.activeElement?.id === 'quick-capture-input') {
                event.preventDefault();
...
_s(useKeyboardShortcuts, "Di3IFf3qQ3/2pa+BJuhqeTrBnNU=", false, function() {
    return [
        useUIStore
    ];
});
...
"[project]/src/components/providers/DataProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DataProvider({ children }) {
    _s();
    const setItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$horizonStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useHorizonStore"])({
        "DataProvider.useHorizonStore[setItems]": (state)=>state.setItems
    }["DataProvider.useHorizonStore[setItems]"]);
    const setSessions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$fleetStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFleetStore"])({
        "DataProvider.useFleetStore[setSessions]": (state)=>state.setSessions
    }["DataProvider.useFleetStore[setSessions]"]);
    const setScore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$fleetStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFleetStore"])({
        "DataProvider.useFleetStore[setScore]": (state)=>state.setScore
    }["DataProvider.useFleetStore[setScore]"]);
    const setRunway = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$fleetStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFleetStore"])({
        "DataProvider.useFleetStore[setRunway]": (state)=>state.setRunway
    }["DataProvider.useFleetStore[setRunway]"]);
    const setActivityEvents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$fleetStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFleetStore"])({
        "DataProvider.useFleetStore[setActivityEvents]": (state)=>state.setActivityEvents
    }["DataProvider.useFleetStore[setActivityEvents]"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DataProvider.useEffect": ()=>{
            // Initialize stores with mock data
            setItems(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockHorizonItems"]);
            setSessions(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockSessions"]);
            setScore(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockConductorScore"]);
            setRunway(4.2); // 4.2 hours runway
            setActivityEvents(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockActivityEvents"]);
        }
    }["DataProvider.useEffect"], [
        setItems,
        setSessions,
...
_s(DataProvider, "vTA+ccjLF0cprZ4CRW3SxNu/ieM=", false, function() {
    return [
...
//# sourceMappingURL=src_b3f16ff8._.js.map